...
data_filepath = r'C:\Users\johna\Desktop\CS2109s Everything\CS2109s\ps3\housing_data.csv'
...
def mean_squared_error(y_true, y_pred):
    ...
    """ YOUR CODE HERE """
    #according to online, np.sqaure words faster than **2 for large arrays
...
def add_bias_column(X):
    ...
    """ YOUR CODE HERE """
    #hstacks add array horizontally
...
def get_bias_and_weight(X, y, include_bias = True):
    ...
    # w = w.reshape(-1)
    # w = np.squeeze(w, axis = 1) #auto removes dimensions of size 1 without speciyfing axis which in this case is always axis = 1
    return w[0], w[1:]
    raise NotImplementedError
    """ YOUR CODE END HERE """
